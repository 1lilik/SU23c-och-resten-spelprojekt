...
public class dadanimationsv2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            animator.Play("animationdaddown");
        }

        else if (Input.GetKey(KeyCode.D) || (Input.GetKey(KeyCode.RightArrow)))
        {
            animator.Play("animationdadright");
        }

        else if (Input.GetKey(KeyCode.A) || (Input.GetKey(KeyCode.LeftArrow)))
        {
            animator.Play("animationdadleft");
        }

        else if (Input.GetKey(KeyCode.W) || (Input.GetKey(KeyCode.UpArrow)))
        {
            animator.Play("animationdadup");
        }

        else
        {
            animator.Play("animationdadidle");
        }
