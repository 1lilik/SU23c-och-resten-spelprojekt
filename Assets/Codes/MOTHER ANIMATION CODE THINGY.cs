...
public class MOTHERANIMATIONCODETHINGY : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            animator.Play("animationleftmom");
        }
        else if ((Input.GetKey(KeyCode.D)) || (Input.GetKey(KeyCode.RightArrow)))
        {
            animator.Play("animationrightmom");
        }
        else if ((Input.GetKey(KeyCode.W)) || (Input.GetKey(KeyCode.UpArrow)))
        {
            animator.Play("animationupmom");
        }
        else if ((Input.GetKey(KeyCode.S)) || (Input.GetKey(KeyCode.DownArrow)))
        {
            animator.Play("animationdownmom");
        }
        else
        {
            animator.Play("animationmomidle");
        }
